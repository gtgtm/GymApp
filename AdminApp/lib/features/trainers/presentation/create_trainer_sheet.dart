...
Future<void> showCreateTrainerSheet(BuildContext context) {
  return showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    builder: (context) => const _CreateTrainerSheet(),
  );
}

class _CreateTrainerSheet extends ConsumerStatefulWidget {
    ...
    return Padding(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text('Add Trainer', style: Theme.of(context).textTheme.titleLarge),
