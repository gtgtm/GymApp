...
String _$dashboardRepositoryHash() =>
    r'6f363ff90d506d1282d4c2f0115aada083f24945';
...
String _$memberRepositoryHash() => r'36c3b3b9f139001edd028bc2265dcc09bf9f3db3';
...
String _$attendanceRepositoryHash() =>
    r'f2f58a574fd0723c0be9fdc8f3e14bceb6330780';
...
String _$paymentRepositoryHash() => r'0f51e6f0074eb82f96d8073f2fcab81eb48cbde1';

@ProviderFor(trainerRepository)
final trainerRepositoryProvider = TrainerRepositoryProvider._();
...
String _$trainerRepositoryHash() => r'054d6c55475aecf62192dde92b75edc5ea369e38';
...
String _$planRepositoryHash() => r'a18ec32c8e055f5a3dc29e171b801bacc836d330';

@ProviderFor(enquiryRepository)
final enquiryRepositoryProvider = EnquiryRepositoryProvider._();

final class EnquiryRepositoryProvider
    extends
        $FunctionalProvider<
          EnquiryRepository,
          EnquiryRepository,
          EnquiryRepository
        >
    with $Provider<EnquiryRepository> {
  EnquiryRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'enquiryRepositoryProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$enquiryRepositoryHash();

  @$internal
  @override
  $ProviderElement<EnquiryRepository> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  EnquiryRepository create(Ref ref) {
    return enquiryRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(EnquiryRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<EnquiryRepository>(value),
    );
  }
}

String _$enquiryRepositoryHash() => r'0243c728ece2a93c03f3ccb84bff965cc254d137';

@ProviderFor(trialRepository)
final trialRepositoryProvider = TrialRepositoryProvider._();

final class TrialRepositoryProvider
    extends
        $FunctionalProvider<TrialRepository, TrialRepository, TrialRepository>
    with $Provider<TrialRepository> {
  TrialRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'trialRepositoryProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$trialRepositoryHash();

  @$internal
  @override
  $ProviderElement<TrialRepository> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  TrialRepository create(Ref ref) {
    return trialRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(TrialRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<TrialRepository>(value),
    );
  }
}

String _$trialRepositoryHash() => r'9eb35c83f47ea536ab76defce79695aa8f53aab0';
...
String _$workoutRepositoryHash() => r'd16d740817cbc33eb9ec94a8190f16677a7256d0';

@ProviderFor(dietRepository)
final dietRepositoryProvider = DietRepositoryProvider._();

final class DietRepositoryProvider
    extends $FunctionalProvider<DietRepository, DietRepository, DietRepository>
    with $Provider<DietRepository> {
  DietRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
  ...
  @override
  String debugGetCreateSourceHash() => _$dietRepositoryHash();

  @$internal
  @override
  $ProviderElement<DietRepository> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  DietRepository create(Ref ref) {
    return dietRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(DietRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<DietRepository>(value),
    );
  }
}

String _$dietRepositoryHash() => r'def7cce6fd06da00c55333a892acc4be04ae51cc';
...
String _$progressRepositoryHash() =>
    r'8c274e482c2916e7fc08ba7b6d0a76379b9f86fb';
...
String _$expenseRepositoryHash() => r'64118b90e5f43f26d766f86d1ad01ff5421a02a5';
